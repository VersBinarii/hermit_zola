...
This theme has `figure` shortcode built in, so you can easily add figcaptions or hyperlink rel attributes to images. Documentations can be found here:

https://github.com/pawndev/hermit_zola/#figure
...
{{ figure(src="https://via.placeholder.com/1600x800",
          ...
          caption="figure-normal (without any classes)",
